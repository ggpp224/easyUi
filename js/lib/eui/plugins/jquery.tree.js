...
(function($) {
	...
	function _c(_d) {
		...
		$(_d).unbind().bind("mouseover", function(e) {
					...
					_e.onMouseover.call(_d, _14(_d, _f[0]));
					e.stopPropagation();
					...
					_e.onMouseout.call(_d, _14(_d, _10[0]));
					//e.stopPropagation();
					...
					if (tt.hasClass("tree-hit")) {
						...
						if (tt.hasClass("tree-checkbox")) {
							...
							_c6(_d, _11[0]);
							_e.onClick.call(_d, _14(_d, _11[0]),e);
						}
					}
					//e.stopPropagation();
	...
	function _18(_19) {
		...
		_1b.find("div.tree-node").draggable({
			...
			onDragOver : function(e, _1e) {
				...
				$(_1e).draggable("proxy").removeClass("tree-dnd-no")
			...
			onDragLeave : function(e, _21) {
				$(_21).draggable("proxy").removeClass("tree-dnd-yes")
			...
			if (ck.length) {
				...
				if (_43.onlyLeafCheck) {
					$("<span class=\"tree-checkbox tree-checkbox0\"></span>")
							.insertBefore(_44.find(".tree-title"));
				}
			}
		} else {
			var ck = _44.find(".tree-checkbox");
	...
	function _4a(_4b, ul, _4c, _4d) {
		...
		function _51(ul, _54, _55) {
			for (var i = 0; i < _54.length; i++) {
				...
				$("<span class=\"tree-title\"></span>").html(_56.text)
						.appendTo(_57);
				if (_4e.checkbox) {
					if (_4e.onlyLeafCheck) {
						if (_56.state == "open"
								&& (!_56.children || !_56.children.length)) {
							if (_56.checked) {
				...
				if (_56.children && _56.children.length) {
					...
					if (_56.state == "open") {
						$("<span class=\"tree-icon tree-folder tree-folder-open\"></span>")
								.addClass(_56.iconCls).prependTo(_57);
	...
	function _59(_5a, ul, _5b) {
		...
		var _61 = $(ul).children("li:last").children("div.tree-node")
				.addClass("tree-node-last");
		_61.children("span.tree-join").removeClass("tree-join")
	...
	function _ae(_af, _b0) {
		...
		if (ul.children("li").length == 0) {
			var _b2 = ul.prev();
			_b2.find(".tree-icon").removeClass("tree-folder")
					.addClass("tree-file");
	...
	function _14(_c0, _c1) {
		var _c2 = $.extend({}, $.data(_c1, "tree-node"), {
					target : _c1,
					checked : $(_c1).find(".tree-checkbox")
							.hasClass("tree-checkbox1")
				});
		if (!_45(_c0, _c1)) {
			_c2.state = $(_c1).find(".tree-hit").hasClass("tree-expanded")
					? "open"
					: "closed";
		}
		return _c2;
	...
	function _ce(_cf, _d0) {
		...
		_d4.width(_d3 + 20);
		_d4.height(document.compatMode == "CSS1Compat" ? (18 - (_d4
				.outerHeight() - _d4.height())) : 18);
	...
	$.fn.tree = function(_e0, _e1) {
		...
		return this.each(function() {
					...
					if (_e2) {
						...
						_e3 = $.extend({}, $.fn.tree.defaults, $.fn.tree
										.parseOptions(this), _e0);
						$.data(this, "tree", {
									options : _e3,
									tree : _1(this)
								});
